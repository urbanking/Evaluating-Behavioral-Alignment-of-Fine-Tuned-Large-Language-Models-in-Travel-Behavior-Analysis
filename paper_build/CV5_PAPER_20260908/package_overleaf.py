...
NEW=OLD.with_name('TRC_English_Overleaf_CV5_20260908.zip');CLEAN=Q/'clean_overleaf_cv5'
...
Conventional models were refitted with training-only inner tuning, seed 42 and
fold metadata excluded from predictors. Numerical and interpretive statements
were updated for the new evidence, including unresolved directional, subgroup
and economic-representation differences.

The project-local CV5_PAPER_20260908 directory retains reproducible analysis code,
...
'''.encode('utf-8')
    manifest={'version':'CV5_20260908','revision':'Retrospective respondent-level five-fold manuscript','files':[]}
